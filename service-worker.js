...
const CRITICAL = ["./index.html", "./catalog.html", "./offline.html", "./css/info.css", "./css/offline.css", "./css/pwa.css", "./css/mobile-header.css", "./css/mobile-navigation.css", "./css/mobile-drawer.css", "./css/design-system.css", "./css/components.css", "./css/utilities.css", "./css/catalog.css", "./css/catalog-browser.css", "./js/store.js", "./js/catalog-repository.js", "./js/catalog.js", "./js/pwa.js", "./js/mobile-navigation.js", "./js/catalog-browser.js", "./js/catalog-browser-core.js", "./data/categories.js", "./data/products.js", "./manifest.webmanifest", "./icons/tabanji-192.png", "./icons/tabanji-512.png", "./icons/tabanji-maskable-512.png", "./icons/apple-touch-icon-180.png"];
...
async function staleWhileRevalidate(request, cacheName, limit) {
  ...
  return cached || await network || await caches.match(request, { ignoreSearch: true }) || Response.error();
}
