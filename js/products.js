document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("keydown",event=>{if(event.key!=="Escape")return;if(els.menu.classList.contains("open"))closeLayer(els.menu,els.menuOverlay,els.openMenu);else if(els.panel.classList.contains("open"))closeLayer(els.panel,els.filterOverlay,els.openFilters);else closeSuggestions()});
